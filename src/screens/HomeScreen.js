...
const HomeScreen = ({navigation}) => {
    ...
    return(
       ...
       >
        {/*  to get a image background <Image
            source={{uri:'https://easy.co.il/images/bgpics/mobile/pic1.jpg'}}
            style={styles.gradient}
        /> */}
        ...
        {/* <View>
          ...
          <Text style={{fontSize:16,fontFamily:Fonts.POPPINS_MEDIUM}}>Add peoples</Text>
            <NumericInput 
              value={0} 
